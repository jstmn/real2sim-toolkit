    ...
    while True:
        ...
        if saver.save_scores:
            ...
            if last_frame:
                ...
                hkl.dump(tmp_to_obj_mapping, path.join(this_out_path, "backward.hkl"), mode="w")

            hkl.dump(prob, path.join(this_out_path, f"{frame_name[:-4]}.hkl"), mode="w", compression="lzf")
