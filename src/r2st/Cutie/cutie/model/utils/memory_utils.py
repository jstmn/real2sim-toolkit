...
# @torch.jit.script
def get_similarity(
    mk: torch.Tensor, ms: torch.Tensor, qk: torch.Tensor, qe: torch.Tensor, add_batch_dim: bool = False
) -> torch.Tensor:
...
def do_softmax(
    similarity: torch.Tensor, top_k: int | None = None, inplace: bool = False, return_usage: bool = False
