...
from .brs import FeatureBRSPredictor, HRNetFeatureBRSPredictor, InputBRSPredictor
...
def get_predictor(
    ...
    if brs_mode == "NoBRS":
        ...
        insertion_mode = {"f-BRS-A": "after_c4", "f-BRS-B": "after_aspp", "f-BRS-C": "after_deeplab"}[brs_mode]

        opt_functor = ScaleBiasOptimizer(
            prob_thresh=prob_thresh, with_flip=with_flip, optimizer_params=lbfgs_params_, **brs_opt_func_params
        )
