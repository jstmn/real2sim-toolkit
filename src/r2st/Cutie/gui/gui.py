...
from PySide6.QtGui import QIcon, QImage, QKeySequence, QPixmap, QShortcut, QTextCursor
...
class GUI(QWidget):
    ...
    def __init__(self, controller, cfg: DictConfig) -> None:
        ...
        self.lcd.setText(f"{0: 5d} / {controller.T - 1: 5d}")
    ...
    def update_slider(self, value):
        self.lcd.setText(f"{value: 3d} / {self.controller.T - 1: 3d}")
